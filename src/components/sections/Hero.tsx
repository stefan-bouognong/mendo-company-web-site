    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(#00D9A6 1px, transparent 1px), linear-gradient(90deg, #00D9A6 1px, transparent 1px)",
            backgroundSize: "60px 60px",
          }}
        />
        {/* Lueur principale */}
        <div className="absolute top-1/4 right-0 w-[700px] h-[700px] bg-accent/10 rounded-full blur-[140px]" />
        <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] bg-gold/5 rounded-full blur-[100px]" />

        {/* Bande diagonale signature — motif kente simplifié */}
        <div
          className="absolute right-0 top-0 h-full w-[45%] opacity-[0.03]"
          style={{
            backgroundImage:
              "repeating-linear-gradient(135deg, #00D9A6 0px, #00D9A6 2px, transparent 2px, transparent 20px), repeating-linear-gradient(45deg, #F59E0B 0px, #F59E0B 1px, transparent 1px, transparent 40px)",
          }}
        />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <span className="text-accent text-sm font-heading font-semibold tracking-wide">
            ...
            >
              ...
              <span className="relative inline-block">
                <span className="text-accent">infrastructures</span>
                <span
                  className="absolute -bottom-1 left-0 w-full h-[3px] bg-accent/40 rounded-full"
                />
              </span>{" "}
              numériques de l'
            ...
            >
              ...
              <a href="#solutions">
                <Button variant="outline" size="lg">Nos Solutions</Button>
              </a>
            </motion.div>
            ...
            <div className="relative">
              ...
              <div className="bg-primary-800 border border-white/10 rounded-2xl p-8 w-80 shadow-2xl">
                ...
                <div className="space-y-3">
                  {["MendoLearn", "Mendo Coti", "Mendo Cash", "Core Banking", "MIA", "Estamp"].map((sol, i) => (
                    <div key={sol} className="flex items-center gap-3 p-3 bg-white/5 rounded-xl hover:bg-accent/10 transition-colors">
                      <div className="w-2 h-2 bg-accent rounded-full" />
                      <span className="text-light/80 text-sm font-medium">{sol}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 bg-gold text-primary-800 rounded-xl px-4 py-2 shadow-lg"
              >
                <p className="text-xs font-heading font-bold">🏆 Blue Tech Challenge</p>
                <p className="text-xs font-medium opacity-75">2ème place</p>
              </motion.div>
            </div>
          </motion.div>
